...
export interface StowagePlanItem {
  id: number;
  plan_id: number;
  order_id: number;
  stowage_position: string | null;
...
export interface StowagePlanWithDetails extends StowagePlan {
  vessel?: Vessel;
  tide_window?: TideWindow;
  items?: (StowagePlanItem & { order?: CargoOrder })[];
